            ...
            tracking-tight">
                ...
                <li class="sm:w-24 md:w-40 m-2 text-center hover:bg-blue-600 ring-1 ring-black ring-opacity-20 rounded-md">
                    <a href="{{route('dashboard')}}" class="text-blue-600 hover:text-white">
                        Accueil <span class="sm:hidden lg:inline-flex">membres</span>
                    </a>
                </li>
            
                <li class="sm:w-24 md:w-40 m-2 text-center hover:bg-gray-300 ring-1 ring-black ring-opacity-20 rounded-md">
                    <a href="{{route('Admin.create')}}">
                        Enregistrer<span class="sm:hidden lg:inline-flex">_Document</span>
                    </a>
                </li>   
            
                <li class="sm:w-24 md:w-40 m-2 text-center hover:bg-gray-300 ring-1 ring-black ring-opacity-20 rounded-md">
                    <a href="{{route('Admin.modif')}}">
                        Modifier<span class="sm:hidden lg:inline-flex">_Document</span>
                    </a>
                </li>    
                <li class="sm:w-24 md:w-40 m-2 text-center hover:bg-gray-300 ring-1 ring-black ring-opacity-20 rounded-md">
                    <a href="{{route('Membres.index')}}">
                        Gestion<span class="sm:hidden lg:inline-flex">_Membres</span>
                    </a>
                </li>    
            </ul>
        </div>
